<template>
  <div class="container">
    ...
    <div v-if="report_flag" class="one-key-report-dialog dialog" style="margin-top: -60px">
      ...
      <div>
        <div class="content-row">
          <span>举报原因</span>
          <select v-model="report_info.report_type" class="report_select" style="width: 100%">
      ...
      <div>
        ...
        <div class="content-row">
          <div v-if="captcha.captcha_image" class="report_captcha">
            <input v-model="report_info.verify_code" maxlength="6" placeholder="请输入图片验证码" type="text"/>
