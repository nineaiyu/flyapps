...
from api.utils.app.analyze import delete_apps_storage,delete_apps_icon_storage
            ...
            if apps_obj:
                ...
                try:
                    if make_master and make_master == act:
                        ...
                        appreleaseobj.update(**{"changelog":request.data.get("changelog",appreleaseobj.first().changelog)})
