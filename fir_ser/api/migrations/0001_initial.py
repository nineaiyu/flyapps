# Generated by Django 3.0.3 on 2021-05-22 11:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('email', models.EmailField(blank=True, max_length=64, null=True, verbose_name='email address')),
                ...
                ('issuer_id', models.CharField(blank=True, max_length=64, null=True, verbose_name='标识创建认证令牌的发放者')),
                ('private_key_id', models.CharField(blank=True, max_length=64, null=True, verbose_name='密钥 ID')),
                ('p8key', models.TextField(blank=True, max_length=512, null=True, verbose_name='p8key')),
                ('auth_type',
                 models.SmallIntegerField(choices=[(0, 'p8key认证'), (1, '用户名密码认证')], default=0, verbose_name='认证类型')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supersign_type',
                 models.SmallIntegerField(choices=[(0, '普通权限'), (1, '特殊权限（包含network、vpn）')], default=0,
                                          verbose_name='签名类型')),
